            ...
            <div className="flex flex-wrap">
              <div className="mb-10 w-full px-4 lg:w-1/2">
                ...
                <p className="max-w-xl text-base font-medium text-paragraph dark:text-secondary lg:text-lg">
                  ...
                  <br />I have a very ambitious nature, thirst for something
                  new, and enjoy working in a team. My daily activities are
                  exploring, designing and coding. and also I like animals like
                  cats and dogs, because they can make me happy every day when
                  I'm tired.
                </p>
              </div>
